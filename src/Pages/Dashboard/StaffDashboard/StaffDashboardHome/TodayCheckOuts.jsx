...
import { FaCalendarCheck, FaCheck, FaSignOutAlt, FaUser } from "react-icons/fa";
    ...
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-800">Today's Check-Outs</h2>
      ...
      <div className="p-5">
        {todayCheckOuts.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl bg-gray-50 px-5 py-10 text-center">
            ...
            <p className="font-medium text-gray-600">No check-outs today</p>

            <p className="mt-1 text-xs text-gray-400">
              There are no guests scheduled to check out today.
            </p>
          </div>
        ) : (
          <div className="space-y-3">
